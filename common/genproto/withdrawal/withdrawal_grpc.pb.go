...
const (
	WithdrawalService_Create_FullMethodName = "/WithdrawalService/Create"
)
...
type WithdrawalServiceClient interface {
	Create(ctx context.Context, in *CreateWithdrawal, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *withdrawalServiceClient) Create(ctx context.Context, in *CreateWithdrawal, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, WithdrawalService_Create_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type WithdrawalServiceServer interface {
	Create(context.Context, *CreateWithdrawal) (*emptypb.Empty, error)
...
func (UnimplementedWithdrawalServiceServer) Create(context.Context, *CreateWithdrawal) (*emptypb.Empty, error) {
...
func _WithdrawalService_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateWithdrawal)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WithdrawalServiceServer).Create(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: WithdrawalService_Create_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WithdrawalServiceServer).Create(ctx, req.(*CreateWithdrawal))
	}
...
var WithdrawalService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "WithdrawalService",
	HandlerType: (*WithdrawalServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Create",
			Handler:    _WithdrawalService_Create_Handler,
		},
	},
