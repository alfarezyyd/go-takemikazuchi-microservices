...
func (c *workerServiceClient) Create(ctx context.Context, in *CreateWorkerRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func _WorkerService_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WorkerServiceServer).Create(ctx, req.(*CreateWorkerRequest))
	}
